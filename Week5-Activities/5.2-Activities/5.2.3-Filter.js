...
const usr6 = data.filter(user => user.userId === 6);

console.log(usr6);

const usr6complete = usr6.filter(user => user.comple === false);
console.log(usr6complete);
// filter for tasks with a title less than 24 characters long
const title24 = data.filter(user => user.title.length < 24);
console.log(title24);
